...
(function () {
  ...
  const BROKEN_TITLE_RE = /\b(403|401|forbidden|unauthorized|access denied|sign in|sign-in|log in|login|session expired|authentication required|session timed out)\b/i;
