...
(function () {
  ...
  const BROKEN_TITLE_RE = /\b(403|401|forbidden|unauthorized|access denied|sign in|log in|session expired|authentication required|session timed out|signed out|logged out)\b/i;
